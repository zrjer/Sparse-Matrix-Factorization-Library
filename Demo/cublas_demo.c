...
int main (int argc, char **argv)
{
    ...
    clock_gettime ( CLOCK_REALTIME, &tp );
    timeInterval = tp.tv_sec + ( double ) ( tp.tv_nsec ) / 1.0e9 - timestamp;
